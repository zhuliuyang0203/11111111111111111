  ...
  module WebDriver
    module Remote
      ...
      class Driver < WebDriver::Driver
        ...
        # @rbs (?capabilities: nil, ?options: Selenium::WebDriver::Chrome::Options, ?service: nil, ?url: String, **untyped) -> void
        ...
        # @rbs (Selenium::WebDriver::Chrome::Options, nil) -> Hash[untyped, untyped]
